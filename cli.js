...
async function init() {
  ...
  program
    .command('init')
    .description('Initialize OculusQAsum in the current directory')
    .action(async () => {
      const spinner = ora('Initializing OculusQAsum...').start();
...
`;
        ...
        spinner.succeed('Initialized OculusQAsum successfully!');
        
        console.log(boxen(
          `${chalk.green('OculusQAsum initialized!')}
